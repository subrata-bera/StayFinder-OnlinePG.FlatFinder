<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingProperties.aspx.cs" Inherits="Admin_PendingProperties" %>
...
<head runat="server">
 ...
 <link href="../General/StyleSheets/PageLoader.css" rel="stylesheet" />
        <link href="../General/StyleSheets/AddProperty.css" rel="stylesheet" /></head>
<body>
    <div id="loader">
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
           ...
           <ItemTemplate>
              <div class="main my-5 px-5 py-3 bg-primary text-white">
                   <div class="name">
                   <h2><%# Eval("PropertyName") %> - <%# Eval("PropertyType") %></h2>
              </div>
              <div class="location fw-bold fs-5"><%# Eval("City") %></div>
              <div class="buttons">
                   <a href='Admin_View.aspx?ID=<%# Eval("ID") %>' class="btn btn-warning">View</a>
               </div>
             </div>
               </ItemTemplate>
        </asp:Repeater>
