        ...
        <h2>User Registration</h2>
         ...
         <div class="mb-3 text-center">
            ...
            <div class="text-center">
                <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary btn-lg" Text="Register" OnClick="RegisterClick"  />
            </div>
             <div class="text-center"> 
                 <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-outline-primary btn-lg w-100 mt-2" NavigateUrl="~/General/UserLogin.aspx" Text="Back to login"></asp:HyperLink>
            </div>
        </form>
    </div>
</div>
