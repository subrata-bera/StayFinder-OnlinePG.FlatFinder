    ...
    <asp:Repeater ID="rptPropertyList" runat="server" OnItemCommand="rptPropertyList_ItemCommand">
                <ItemTemplate>
                    ...
                    <div class="card border-dark" style="width: 18rem;">
                        <img src="data:image/png;base64,<%# Convert.ToBase64String((byte[])Eval("PropertyImage")) %>" class="card-img-top" alt="Property Image">
                        <div class="card-body">
                            <h5 class="card-title"><%# Eval("PropertyName") %></h5>
                            <p class="card-text"><%# Eval("Description") %></p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Rent: <%# Eval("Rent") %></li>
                            <li class="list-group-item">Facilities: <%# Eval("Facilities_1") %> ,<%# Eval("Facilities_2") %> ,<%# Eval("Facilities_3") %></li>
                            <li class="list-group-item">For <%# Eval("Gender") %></li>
                            <li class="list-group-item">Status: <%# Eval("ApprovalStatus") %></li>
                            <li class="list-group-item">Approved by: <%# Eval("ApprovedBy") %></li>


                        </ul>
                        <div class="card-body">
                           <asp:LinkButton ID="btnDelete" CssClass="btn btn-danger" runat="server" CommandName="DeleteProperty"
                        CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('Are you sure you want to delete this property?');">
                        Delete
                    </asp:LinkButton>
